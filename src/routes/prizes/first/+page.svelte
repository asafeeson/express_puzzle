...
<div class="flex flex-col h-dvh px-6 pb-[10%]">
	...
	>
		<div class="overflow-hidden rounded-2xl aspect-square relative w-full gap-4">
			<img src="/small_puzzle_overlay_black.png" alt="" class="h-full w-auto object-fill absolute z-1 opacity-100 mix-blend-difference" />
            <img src="/small_puzzle_image.png" alt="" class="h-full w-auto object-fill absolute z-0 inset-0" />
		</div>
